...
exports.steps = steps;
},{"tslib":"node_modules/tslib/tslib.es6.js","hey-listen":"node_modules/hey-listen/dist/hey-listen.es.js","style-value-types":"node_modules/style-value-types/dist/style-value-types.es.js","framesync":"node_modules/framesync/dist/framesync.es.js"}],"dogs.js":[function(require,module,exports) {
var popmotion = require("popmotion");

var BREEDS_URL = "https://dog.ceo/api/breeds/list/all";
var DOG_URL_BASE = "https://dog.ceo/api/breed/selectedBreed/images/random";
var dogImageURL = null;
var selectedBreed = null;
var buttonActive = false;
var breeds_list = [];
var dogPhotoURL = [];
var fetchSuccess = true; // DOM //

var SELECT_LIST = document.querySelector('.select-css');
var FORM_BUTTON = document.querySelector('.app-menu button');
var APP_DISPLAY = document.querySelector('.app-display');
var DOG_ICON = document.querySelector(".fas.fa-dog"); // FUNCTIONS //
...
function getBreedList() {
  var promise = fetch(BREEDS_URL);
  promise.then(handleFetchErrors).then(function (response) {
    ...
    for (breed in fetchedList) {
      fetchedListCleaned.push(breed);
    }
...
function fetchDogPicture() {
  var DOG_URL = DOG_URL_BASE.replace('selectedBreed', selectedBreed);
...
function rerenderBreedList() {
  ...
  if (breeds_list.length) {
    breeds_list.forEach(function (breed) {
      var optionText = capitalizeFirstLetter(breed);
      var optionTemplate = "<option value=\"".concat(breed, "\">").concat(optionText, "</option>");
...
function animateUpDown() {
  popmotion.animate({
    ...
    onUpdate: function onUpdate(latest) {
      return DOG_ICON.style.transform = "rotate(-".concat(latest, "deg)");
    }
  });
}
...
},{}]},{},["../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","dogs.js"], null)
